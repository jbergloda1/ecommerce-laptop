      ...
      <div class="row">
        <div class="col-md-10">
          <b-button variant="warning">
            <b-link class="comeback" href="#" to="/home"><b-icon icon="arrow-return-left"></b-icon>
            Continue Purchase</b-link>
          </b-button>
        </div>
        <div class="col-md-1">
          <b-link href="#" to="/checkout">
          <b-button class="paym" variant="success">CHECKOUT</b-button></b-link>
        </div>
        <div class="col-md-1">
          <b-button class="paym" variant="primary" @click="clear()">CLEAR</b-button>
        </div>
